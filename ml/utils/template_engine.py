...
class BaseTemplate(object):
    def __init__(self, template_name, output_name, template_dir="publicEnv/source/templates",
                 output_dir="publicEnv/outputs"):
...
def _generate_crawl_template(project, rule_fields):
    t = CrawlTemplate(template_name="scrapy.cfg.tpl", output_name="scrapy.cfg",
                      output_dir="publicEnv/outputs/" + project.md5)
...
def generate_crawl(project, rule_fields, output_dirs="publicEnv/outputs/"):
